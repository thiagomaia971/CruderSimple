...
namespace CruderSimple.DynamoDb;
    ...
    where T: Entity
{
    ...
    {
        return ByGsi(x => x.InheritedKey, value)
            .ByInheritedType();
    }

    public DynamoDbQueryBuilder<T> ByInheritedKey(string value, DynamoDbOperator queryOperator = DynamoDbOperator.Equal)
    {
        _conditions.Add(DynamoDbCondition.Create("InheritedKey", queryOperator, value));
        return this;
    }
